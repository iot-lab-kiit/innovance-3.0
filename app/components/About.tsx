    ...
    <section className="bg-[#101010] min-h-96 w-full p-12" id="about">
      ...
      <div className="flex justify-center ">
        <div className="Section-title mt-8 ">
          <div
            className={`outline-none flex justify-center align-middle flex-col
    shrink-0 ${bitter.className}`}
          >
            <h1 className="lg:text-6xl sm:text-4xl text-4xl text-center">
              {" "}
              Why Attend
            </h1>
          </div>
          <div
            className={`outline-none flex justify-center align-middle flex-row
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
          <div className="md:h-56 mt-6 sm:h-52 h-48 w-11/12 my-1  mx-5 rounded-2xl  border-zinc-700 border-2  overflow-hidden  flex-grow transform transition-transform duration-300 hover:scale-105">
            <div className="title flex ">
              <div className="image w-8 mx-4 mt-5 h-8 opacity-100">
                <svg
                  ...
                  viewBox="0 0 256 256"
                  focusable="false"
                  color="var(--token-551512d3-7ccf-4658-8a33-3240b782b72f, rgb(59, 130, 246))"
                  style={{
                    userSelect: "none",
                    width: "100%",
                    height: "100%",
                    display: "inline-block",
                    fill: "var(--token-551512d3-7ccf-4658-8a33-3240b782b72f, rgb(59, 130, 246))",
                    color:
                      "var(--token-551512d3-7ccf-4658-8a33-3240b782b72f, rgb(59, 130, 246))",
                    flexShrink: 0,
                  }}
                >
                  <g color="var(--token-551512d3-7ccf-4658-8a33-3240b782b72f, rgb(166, 240, 0))">
            ...
            <div className="describtion relative ">
              ...
              >
                Engage with thought-provoking sessions featuring up-to-date and
                captivating content from industry leaders.
              </p>
            </div>
          </div>
          <div className="md:h-56 mt-6 sm:h-52 h-48 w-11/12 my-1  mx-5 rounded-2xl  border-zinc-700 border-2  overflow-hidden  flex-grow  transform transition-transform duration-300 hover:scale-105">
            ...
            <div className="describtion relative ">
              <p
                className={`sm:text-base text-sm h-fit overflow-hidden break-words m-5 tracking-wide leading-relaxed ${poppins.className}`}
              >
                Connect with fellow innovation enthusiasts, entrepreneurs, and
                industry professionals for valuable networking.
              </p>
            </div>
          </div>
          <div className="md:h-56 mt-6 sm:h-52 h-48 w-11/12 my-1  mx-5 rounded-2xl  border-zinc-700 border-2  overflow-hidden  flex-grow  transform transition-transform duration-300 hover:scale-105">
            <div className="title flex just">
              <div className="image w-8 mx-4 mt-5 h-8 opacity-100">
                <svg
                  ...
                  viewBox="0 0 256 256"
                  focusable="false"
                  color="var(--token-551512d3-7ccf-4658-8a33-3240b782b72f, rgb(166, 240, 0))"
                  style={{
                    userSelect: "none",
                    width: "100%",
                    height: "100%",
                ...
                >
                  <g color="var(--token-551512d3-7ccf-4658-8a33-3240b782b72f,  rgb(59, 130, 246))">
          ...
          <div className="md:h-56 mt-6 sm:h-52 h-48 w-11/12 my-1  mx-5 rounded-2xl  border-zinc-700 border-2  overflow-hidden  flex-grow  transform transition-transform duration-300 hover:scale-105">
            ...
            <div className="describtion relative ">
              <p
                className={`sm:text-base text-sm h-fit overflow-hidden break-words m-5 tracking-wide leading-relaxed ${poppins.className}`}
              >
                Engage with industry leaders and visionaries delivering
