...
function About() {
  return (
    <section
      className="bg-[#101010] min-h-screen flex justify-center items-center"
      id="about"
    >
      <div>
        <Star />
        <div className="flex justify-center items-center lg:w-[80vw]">
    ...
    shrink-0 ${poppins.className} mt-3`}
        ...
        <div className="Cards mt-5">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 lg:w-[80vw]">
