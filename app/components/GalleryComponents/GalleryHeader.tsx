...
const GalleryHeader = () => {
  return (
    <header className="text-center py-10">
      <h3 className="lg:text-4xl font-bold text-blue-500 mb-2 lg:pt-10 lg:pb-2">
        Gallery
      </h3>
      ...
      <p className="text-base lg:px-[25vw] lg:py-5 sm:text-lg text-white px-4 sm:px-16 md:px-32">
        ...
        and the vibrant conference atmosphere. Witness unforgettable moments
        from the Laonga Event.
      </p>
